      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="flex items-center gap-1 rounded-full bg-purple-50 dark:bg-purple-950/40 px-2.5 py-0.5 text-xs font-semibold text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800/60">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-3xl border border-purple-100 dark:border-[#27272A] bg-gradient-to-br from-purple-50 to-white dark:from-[#151719] dark:to-[#1B1D20] p-5 shadow-sm">
            <div className="text-xs font-bold text-purple-800 dark:text-purple-300 uppercase tracking-wider flex items-center justify-between">
              <span>{t("genetics.herd_index", "Herd Genetic Index")}</span>
              <Award className="h-4 w-4 text-purple-600 dark:text-purple-400" />
            </div>
            <div className="mt-3 flex items-baseline gap-2">
              <span className="text-3xl font-black text-purple-950 dark:text-[#F4F4F5]">
          ...
          <div className="rounded-3xl border border-emerald-100 dark:border-[#27272A] bg-gradient-to-br from-emerald-50 to-white dark:from-[#151719] dark:to-[#1B1D20] p-5 shadow-sm">
            <div className="text-xs font-bold text-emerald-800 dark:text-emerald-400 uppercase tracking-wider flex items-center justify-between">
              <span>{t("genetics.pedigree_coverage", "Pedigree Coverage")}</span>
              <ShieldCheck className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
            </div>
            <div className="mt-3 flex items-baseline gap-2">
              <span className="text-3xl font-black text-emerald-950 dark:text-[#F4F4F5]">
          ...
          <div className="rounded-3xl border border-amber-100 dark:border-[#27272A] bg-gradient-to-br from-amber-50 to-white dark:from-[#151719] dark:to-[#1B1D20] p-5 shadow-sm">
            <div className="text-xs font-bold text-amber-800 dark:text-amber-400 uppercase tracking-wider flex items-center justify-between">
              <span>{t("genetics.top_sire", "Top Sire Line")}</span>
              <Sparkles className="h-4 w-4 text-amber-600 dark:text-amber-400" />
            </div>
            <div className="mt-3 text-xl font-black text-amber-950 dark:text-[#F4F4F5] truncate">
          ...
          <div className="rounded-3xl border border-sky-100 dark:border-[#27272A] bg-gradient-to-br from-sky-50 to-white dark:from-[#151719] dark:to-[#1B1D20] p-5 shadow-sm">
            <div className="text-xs font-bold text-sky-800 dark:text-sky-300 uppercase tracking-wider flex items-center justify-between">
            ...
            <div className="mt-3 flex items-baseline gap-2">
              ...
              <span className="text-xs font-semibold text-sky-700 dark:text-sky-300">Canonical Bulls</span>
            </div>
        ...
        {/* Tab Controls */}
        <div className="flex border-b border-slate-200 dark:border-[#27272A]">
          <button
            onClick={() => setActiveTab("sires")}
            className={`pb-3 px-4 text-sm font-bold border-b-2 transition ${
              activeTab === "sires"
                ? "border-purple-600 text-purple-600 dark:text-purple-400 dark:border-purple-400"
                : "border-transparent text-slate-500 dark:text-[#A1A1AA] hover:text-slate-800 dark:hover:text-[#F4F4F5]"
            }`}
          >
            ...
            {isSiresLoading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-slate-100 dark:border-[#27272A] text-xs font-bold text-slate-400 dark:text-[#A1A1AA] uppercase tracking-wider">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-[#27272A] font-medium">
                    {sires.map((sire) => (
                      <tr key={sire.id} className="hover:bg-slate-50/80 dark:hover:bg-[#1B1D20]/80 transition">
                        <td className="py-3.5 px-4 font-black">
                          {sire.rank === 1 ? (
                            <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 text-xs font-black">
                              🥇 1
                            </span>
                          ) : sire.rank === 2 ? (
                            <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-slate-200 dark:bg-[#1B1D20] text-slate-700 dark:text-slate-300 text-xs font-black">
                              🥈 2
                            </span>
                          ) : sire.rank === 3 ? (
                            <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-amber-800/10 dark:bg-amber-950/40 text-amber-900 dark:text-amber-300 text-xs font-black">
                              🥉 3
                            </span>
                          ) : (
                            <span className="text-slate-500 dark:text-[#A1A1AA] font-bold ml-2">#{sire.rank}</span>
                          )}
                        </td>
                        <td className="py-3.5 px-4 font-black text-slate-900 dark:text-[#F4F4F5]">
                          {sire.name}
                        </td>
                        <td className="py-3.5 px-4 font-bold text-slate-600 dark:text-[#A1A1AA]">
                          <code className="rounded-lg bg-slate-100 dark:bg-[#1B1D20] border dark:border-[#27272A] px-2 py-0.5 text-xs text-slate-700 dark:text-[#F4F4F5]">
                            {sire.sire_code}
                          </code>
                        </td>
                        <td className="py-3.5 px-4 text-slate-700 dark:text-[#F4F4F5]">
                        ...
                        <td className="py-3.5 px-4">
                          <div className="flex items-center gap-2">
                            <span className="font-black text-purple-900 dark:text-purple-300 text-xs">
                              {sire.genetic_merit_score.toFixed(1)}
                            </span>
                            <div className="h-2 w-20 overflow-hidden rounded-full bg-slate-100 dark:bg-[#1B1D20]">
                              <div
        ...
        {activeTab === "cows" && (
          <div className="rounded-3xl border border-slate-200 dark:border-[#27272A] bg-white dark:bg-[#151719] p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-[#F4F4F5] flex items-center gap-2">
                  <Dna className="h-4 w-4 text-purple-600 dark:text-purple-400" />
            ...
            {isHerdLoading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-[#27272A] font-medium">
                    {cowProfiles.map((cow) => (
                      <tr key={cow.cow_id} className="hover:bg-slate-50/80 dark:hover:bg-[#1B1D20]/80 transition">
                        <td className="py-3.5 px-4 font-black text-slate-900 dark:text-[#F4F4F5]">
                          🐄 {cow.cow_name}
                          <span className="block text-xs font-normal text-slate-500 dark:text-[#A1A1AA]">
                            Tag: {cow.tag_id}
                          </span>
                        </td>
                        <td className="py-3.5 px-4 text-slate-700 dark:text-[#F4F4F5]">
                        ...
                        <td className="py-3.5 px-4 font-bold text-slate-800 dark:text-[#F4F4F5]">
                          {cow.sire_name ? (
                            <span>{cow.sire_name} <span className="text-xs text-slate-500 dark:text-[#A1A1AA]">({cow.sire_code})</span></span>
                          ) : (
                            <span className="text-slate-400 dark:text-[#A1A1AA] font-normal italic">Unrecorded Sire</span>
                          )}
                        </td>
                        <td className="py-3.5 px-4">
                          {cow.pedigree_status === "Verified Sire Pedigree" ? (
                            <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100 dark:bg-emerald-500/10 px-2.5 py-0.5 text-xs font-bold text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/20">
                              <ShieldCheck className="h-3 w-3" />
                              Verified Pedigree
                            </span>
                          ) : (
                            <span className="inline-flex items-center gap-1 rounded-full bg-slate-100 dark:bg-[#1B1D20] px-2.5 py-0.5 text-xs font-semibold text-slate-600 dark:text-[#A1A1AA] border border-slate-200 dark:border-[#27272A]">
                        ...
                        <td className="py-3.5 px-4">
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-xl bg-purple-50 dark:bg-purple-950/50 border border-purple-200/60 dark:border-purple-800/60 px-3 py-1.5 text-xs font-bold text-purple-700 dark:text-purple-300 transition hover:bg-purple-100 dark:hover:bg-purple-900/50"
                          >
                            Inspect Profile
        ...
        {selectedCow && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 dark:bg-black/70 p-4 backdrop-blur-xs">
            <div className="relative w-full max-w-2xl rounded-3xl bg-white dark:bg-[#151719] border border-slate-200 dark:border-[#27272A] p-6 shadow-2xl space-y-6">
              {/* Modal Header */}
              <div className="flex items-start justify-between border-b border-slate-100 dark:border-[#27272A] pb-4">
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="text-xl font-black text-slate-900 dark:text-[#F4F4F5]">
                      Genetic Profile — {selectedCow.cow_name}
                    </h3>
                    <span className="rounded-full bg-purple-100 dark:bg-purple-950/60 px-2.5 py-0.5 text-xs font-bold text-purple-800 dark:text-purple-300 border border-purple-200 dark:border-purple-800/60">
                ...
                <button
                  ...
                  className="rounded-full p-1 text-slate-400 hover:bg-slate-100 dark:hover:bg-[#1B1D20] hover:text-slate-600 dark:hover:text-[#F4F4F5]"
                >
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <div
                className={`rounded-2xl p-4 border flex items-center justify-between ${
                  selectedCow.pedigree_status === "Verified Sire Pedigree"
                    ? "border-emerald-200 dark:border-emerald-500/20 bg-emerald-50/70 dark:bg-emerald-500/10 text-emerald-950 dark:text-emerald-300"
                    : "border-slate-200 dark:border-[#27272A] bg-slate-50 dark:bg-[#1B1D20] text-slate-800 dark:text-[#F4F4F5]"
                }`}
              >
                ...
                <div className="text-right">
                  <span className="text-xs uppercase font-bold text-slate-500 dark:text-[#A1A1AA]">Merit Rating</span>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4 rounded-2xl border border-slate-200 dark:border-[#27272A] bg-slate-50/60 dark:bg-[#1B1D20] p-4">
                  {/* Sire Card */}
                  <div className="rounded-xl border border-purple-200 dark:border-purple-800/60 bg-white dark:bg-[#151719] p-3 shadow-2xs">
                    <span className="text-xs font-bold text-purple-800 dark:text-purple-300 uppercase tracking-wider">
                      Sire (Father)
                    </span>
                    <div className="mt-1 font-black text-slate-900 dark:text-[#F4F4F5] text-sm">
                      {selectedCow.sire_name || "Unrecorded Sire"}
                    </div>
                    {selectedCow.sire_code && (
                      <span className="text-xs text-slate-500 dark:text-[#A1A1AA] font-semibold">
                  ...
                  {/* Dam Card */}
                  <div className="rounded-xl border border-slate-200 dark:border-[#27272A] bg-white dark:bg-[#151719] p-3 shadow-2xs">
                    <span className="text-xs font-bold text-slate-500 dark:text-[#A1A1AA] uppercase tracking-wider">
                      Dam (Mother)
                    </span>
                    <div className="mt-1 font-black text-slate-900 dark:text-[#F4F4F5] text-sm">
                      {selectedCow.dam_name || "Unrecorded Dam"}
                    </div>
                    <span className="text-xs text-slate-400 dark:text-[#A1A1AA]">Dam Line</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-2xl border border-purple-100 dark:border-purple-800/50 bg-purple-50/50 dark:bg-purple-950/30 p-4">
                  <span className="text-xs font-bold text-purple-800 dark:text-purple-300 uppercase tracking-wider">
                    Genetic Yield Potential
                  </span>
                  <div className="mt-1 text-2xl font-black text-purple-950 dark:text-[#F4F4F5]">
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-[#27272A] bg-slate-50 dark:bg-[#1B1D20] p-4">
                  ...
                  <div className="mt-1 text-2xl font-black text-slate-900 dark:text-[#F4F4F5]">
              ...
              <div className="space-y-2">
                <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-[#A1A1AA]">
                ...
                <ul className="space-y-2">
                  {selectedCow.breeding_insights.map((insight, idx) => (
                    <li
                      key={idx}
                      className="flex items-start gap-2.5 rounded-xl border border-slate-100 dark:border-[#27272A] bg-slate-50 dark:bg-[#1B1D20] p-3 text-xs font-medium text-slate-800 dark:text-[#F4F4F5]"
                    >
              ...
              {/* Modal Footer */}
              <div className="flex justify-end border-t border-slate-100 dark:border-[#27272A] pt-4">
                <button
                  onClick={() => setSelectedCow(null)}
                  className="rounded-2xl bg-slate-900 dark:bg-emerald-600 px-5 py-2.5 text-xs font-bold text-white shadow-sm hover:bg-slate-950 dark:hover:bg-emerald-700"
                >
                  Close Profile
                </button>
              </div>
